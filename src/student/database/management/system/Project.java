...
public class Project extends JFrame implements ActionListener {
 ...
 Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/third.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon2.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon4.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon14.jpg"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon15.png"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon15.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon14.jpg"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon17.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon6.png"));
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon7.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon8.png"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon10.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon11.png"));
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon13.jpg"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("student/database/management/system/icons/icon12.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Student Admission")){
            ...
            try{
                Runtime.getRuntime().exec("C:\\Program Files\\Google\\Chrome\\Application.exe");
            }catch(Exception e){ }
